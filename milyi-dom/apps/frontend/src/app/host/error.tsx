...
export default function HostError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('Host area error:', error);
  }, [error]);

  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center bg-sand-50 px-4 text-center">
      <div className="mb-6 text-7xl">⚠️</div>
      <h1 className="text-2xl font-bold text-slate-800">Ошибка в панели хозяина</h1>
