...
export default function LoginPage() {
  ...
  const handleForgotPassword = async (event: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('We have sent password reset instructions to your email.');
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Use one of the demo accounts below if the API is unavailable.
          </p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <div className="text-xs text-blue-700 space-y-1">
            <div><strong>Host:</strong> host@example.com / password123</div>
            <div><strong>Guest:</strong> guest@example.com / password123</div>
